...
class MockTest(unittest.TestCase):
    ...
    def _check_speced_something(self, something):
    ...
    def test_mock_spec_all_members(self):
        for spec in [Something, Something()]:
            mock = Mock(spec=spec)
            self._check_speced_something(mock)
    ...
    def test_patch_autospec_obj(self):
        ...
        with patch.multiple(something, meth=DEFAULT, cmeth=DEFAULT,
            ...
            self._check_speced_something(something)
    ...
    def test_mock_add_spec_all_members(self):
        for spec in [Something, Something()]:
            mock = Mock()
            mock.mock_add_spec(spec)
            self._check_speced_something(mock)
